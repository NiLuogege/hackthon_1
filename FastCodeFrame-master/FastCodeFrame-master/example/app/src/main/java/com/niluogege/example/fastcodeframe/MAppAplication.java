...
public class MAppAplication extends BaseApplication {
    ...
    public void onCreate() {
        ...
        voideMap.put(2, new VideoInfo("going", R.raw.going));
        voideMap.put(3, new VideoInfo("林生-1", R.raw.ls_1));
        voideMap.put(4, new VideoInfo("林生-2", R.raw.ls_2));
        voideMap.put(5, new VideoInfo("NiLuogege", R.raw.lc));
        voideMap.put(6, new VideoInfo("女性-1", R.raw.nv_1));
        voideMap.put(7, new VideoInfo("女性-2", R.raw.nv_2));
        voideMap.put(8, new VideoInfo("dog", R.raw.dog));
        voideMap.put(9, new VideoInfo("pag", R.raw.pag));
        voideMap.put(10, new VideoInfo("乐园", R.raw.ly));
        voideMap.put(11, new VideoInfo("雅妮", R.raw.yn));
        voideMap.put(12, new VideoInfo("聪美_1", R.raw.cm_1));
        voideMap.put(13, new VideoInfo("聪美_2", R.raw.cm_2));
        voideMap.put(14, new VideoInfo("杨磊", R.raw.ll_1));
