package com.niluogege.example.fastcodeframe.view;
...
public class RoundImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    //圆角大小，默认
    private int mBorderRadius = dip2px(getContext(), 25);
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int radius = typedArray.getInt(R.styleable.RoundImageView_radius, 4);
        mBorderRadius = dip2px(getContext(), radius);
        typedArray.recycle();
