...
public class ILog {
    ...
    private static String LOG_FILE_PATH = getLogFilePath(); // 日志文件保存路径 这个可能需要修改
    ...
    private static String LOG_TAG = "ILog"; // 默认的tag
    ...
    public static String getLogFilePath() {
        ...
        if (TextUtils.isEmpty(sdCardPath)) {
            ...
            return sdCardPath + File.separator + "airent" + File.separator + "log";
        }
    }
